...
PacketInfo msg_command_encode(uint32_t speed_left_pct, uint32_t speed_right_pct) {
    PacketInfo result;
...
void msg_command_decode(PacketInfo packet, uint32_t* speed_left_pct, uint32_t* speed_right_pct) {
